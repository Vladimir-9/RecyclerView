...
class GridListCarFragment : Fragment(R.layout.fragment_list), AddCar {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        listCar =
            if (savedInstanceState == null) listCar else {
                savedInstanceState.getParcelableArray(SAVE_GRID_LIST_CAR)?.toList() as List<Car>
            }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelableArray(SAVE_GRID_LIST_CAR, listCar.toTypedArray())
    }
    ...
    companion object {
        const val SAVE_GRID_LIST_CAR = "saveGridListCar"
    }
}